This was an complete python programming language based project . If  user want to used this code or project , firstly they have to install some python module .
